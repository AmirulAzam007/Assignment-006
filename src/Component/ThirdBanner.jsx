...
const ThirdBanner = () => {
  ...
  <div className="card-body">
    ...
    <div className="mt-6">
      <button className="btn bg-purple-500 text-white btn-block rounded-2xl">Subscribe</button>
    </div>
  </div>
</div>
           ...
           <div className="relative card w-full bg-purple-500 shadow-sm">
  <div className="card-body">
    <span className="badge absolute lg:left-48 md:left-31 sm:left-55 bottom-91 badge-xs badge-warning p-3 font-bold">Most Popular</span>
    <div className="space-y-2">
      <h2 className="text-3xl font-bold text-white">Premium</h2>
      <p className='text-gray-400 text-white'>Best For Professionals</p>
    ...
    <div className="mt-6">
      <button className="btn text-purple-500 rounded-2xl btn-block">Subscribe</button>
    </div>
  </div>
</div>
  ...
  <div className="card-body">
    <div className="space-y-2">
      ...
      <p className='text-gray-400'>For Teams and Business</p>
      <span className="text-xl font-bold">$29/mo</span>
    </div>
    <ul className="mt-2 flex flex-col gap-2 text-xs">
      <li>
    ...
    <div className="mt-6">
      <button className="btn bg-purple-500 text-white rounded-2xl btn-block">Subscribe</button>
    </div>
  </div>
</div>
